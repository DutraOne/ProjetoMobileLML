    ...
    <ScrollView contentContainerStyle={styles.container}>
      <View style={styles.box}>
        <View style={styles.logoContainer}>
          <Image
            source={require("@/assets/images/adaptive-icon.png")} // substitua pelo caminho correto ou use URI
            style={styles.logo}
          />
        </View>
        ...
        <Text style={styles.description}>
          ...
          lar cheio de amor a um pet que espera por você. Baixe agora e faça a diferença na vida de
          um animal!
        </Text>

        <View style={styles.loginContainer}>
          <TouchableOpacity onPress={() => {/* implementar recuperação de senha */}}>
